    ...
    switch (coffeeId) {
      case ClassicCoffee.id:
        ...
        if (this.checkEnoughCoffee("Classic Coffee")) {
          ...
          if (
            ClassicCoffee.price <= money &&
            this.money >= money - ClassicCoffee.price
          ) {
            this.money += money;
            this.cookCoffee("Classic Coffee", sugar);
            ...
            return money - ClassicCoffee.price;
          }
      ...
      case Cappuccino.id:
        ...
        if (this.checkEnoughCoffee("Cappuccino")) {
          ...
          if (card) {
            //Check if the payment is successful. If it is, cook the coffee.
            if (this.cardPayment.pay(Cappuccino.price)) {
          ...
          if (
            Cappuccino.price <= money &&
            this.money >= money - Cappuccino.price
          ) {
            this.money += money;
            this.cookCoffee("Cappuccino", sugar);
            if (Cappuccino.price == money) {
              return 0;
            }
            return money - Cappuccino.price;
          }
      ...
      case Latte.id:
        ...
        if (this.checkEnoughCoffee("Latte")) {
          ...
          if (card) {
            //Check if the payment is successful. If it is, cook the coffee.
            if (this.cardPayment.pay(Latte.price)) {
          ...
          if (Latte.price <= money && this.money >= money - Latte.price) {
            this.money += money;
            this.cookCoffee("Latte", sugar);
            if (Latte.price == money) {
              return 0;
            }
            return money - Latte.price;
          }
      ...
      case Espresso.id:
        ...
        if (this.checkEnoughCoffee("Espresso")) {
          ...
          if (card) {
            //Check if the payment is successful. If it is, cook the coffee.
            if (this.cardPayment.pay(Espresso.price)) {
          ...
          if (Espresso.price <= money && this.money >= money - Espresso.price) {
            this.money += money;
            this.cookCoffee("Espresso", sugar);
            if (Espresso.price == money) {
              return 0;
            }
            return money - Espresso.price;
          }
